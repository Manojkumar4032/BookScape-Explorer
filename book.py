...
st.markdown(
    ...
    .stApp {
        background-color:rgb(245, 182, 162); /* Light grayish-blue */
    }
    </style>
...
st.markdown(
    ...
    .custom-title-1 {
        ...
        padding: 10px;
        background: linear-gradient(90deg,rgb(249, 102, 57) ,rgb(146, 234, 248)); /* Gradient background */
        border-radius: 10px;
    }
    </style>
...
st.markdown(
    ...
    .custom-title-2 {
        ...
        text-shadow: 2px 2px 4px #000000; /* Black shadow */
        padding: 10px;
        background: linear-gradient(90deg,rgb(236, 120, 203) ,rgb(189, 238, 166)); /* Gradient background */
        border-radius: 8px;
    }
    </style>
